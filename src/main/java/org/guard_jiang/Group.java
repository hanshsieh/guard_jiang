...
public class Group {
    ...
    public Group(@Nonnull Storage storage, @Nonnull String groupId) {
    ...
    public void removeRoleOfUser(@Nonnull String userId) throws IOException {
        storage.removeGroupRole()
                .withGroupId(id)
                .withUserId(userId)
                .remove();
    }
